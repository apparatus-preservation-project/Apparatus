...
public class Wheel extends GrabableObject implements FreeObject {
	...
	public Wheel(World world, float size2) {
		if (!_initialized) {
			_init();
		}
	...
	public static void _init() {
		if (!_initialized) {
			...
			for (int c = 0; c < 24; c++) {
				float x = (float) Math.cos(((double) c) * 0.2617993877991494d);
				float y = (float) Math.sin(((double) c) * 0.2617993877991494d);
				if (c == 0) {
			...
			for (int c2 = 0; c2 < 24; c2++) {
				float x2 = (float) Math.cos(((double) c2) * 0.2617993877991494d);
				float y2 = (float) Math.sin(((double) c2) * 0.2617993877991494d);
				float nx = (float) Math.cos(((double) (c2 + 1)) * 0.2617993877991494d);
				float ny = (float) Math.sin(((double) (c2 + 1)) * 0.2617993877991494d);
