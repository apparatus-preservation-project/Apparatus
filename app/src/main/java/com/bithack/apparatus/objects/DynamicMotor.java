...
public class DynamicMotor extends BaseMotor {
	...
	@Override // com.bithack.apparatus.objects.GrabableObject, com.bithack.apparatus.objects.BaseMotor, com.bithack.apparatus.objects.BaseObject
	...
	public void rotate(float ro) {
		...
		if (this.cabled) {
			...
			rot.setToRotation((float) (((double) get_angle()) * 57.29577951308232d));
	...
	@Override // com.bithack.apparatus.objects.GrabableObject, com.bithack.apparatus.objects.BaseMotor
	public void play() {
		destroy_sensors();
	...
	public void render_deco() {
		...
		G.gl.glPushMatrix();
		G.gl.glTranslatef(pos.x, pos.y, 1.27f + ((float) this.layer));
