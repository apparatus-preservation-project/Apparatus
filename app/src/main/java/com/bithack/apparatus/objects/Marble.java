...
public class Marble extends GrabableObject implements PrimaryObject {
	...
	public static void _init() {
		...
		silhouette_mesh = new Mesh(true, 34, 0, new VertexAttribute(1, 3, "a_position"));
		...
		rotation.setToRotation(axis, (float) Math.acos(((double) axis.dot(light_dir)) * 57.29577951308232d));
		for (int x = 0; x < 17; x++) {
			double ac = ((double) x) * 0.39269908169872414d;
			int o = x * 6;
	...
	public static void _init_materials() {
		G.gl.glMaterialfv(1032, 4608, material, 0);
		G.gl.glMaterialfv(1032, 4609, material, 4);
		G.gl.glMaterialfv(1032, 4610, material, 8);
		G.gl.glMaterialfv(1032, 5633, material, 12);
	}

	public static void _init_diffuse_materials() {
		G.gl.glMaterialfv(1032, 4608, diffuse_material, 0);
		G.gl.glMaterialfv(1032, 4609, diffuse_material, 4);
		G.gl.glMaterialfv(1032, 4610, diffuse_material, 8);
		G.gl.glMaterialfv(1032, 5633, diffuse_material, 12);
	}

	public static void _init_diffuse_christmas_materials() {
		G.gl.glMaterialfv(1032, 4608, diffuse_christmas_material, 0);
		G.gl.glMaterialfv(1032, 4609, diffuse_christmas_material, 4);
		G.gl.glMaterialfv(1032, 4610, diffuse_christmas_material, 8);
		G.gl.glMaterialfv(1032, 5633, diffuse_christmas_material, 12);
	}
	...
	public void render() {
		...
		float angle = s.angle;
		G.gl.glPushMatrix();
		G.gl.glTranslatef(pos.x, pos.y, 0.75f + ((float) this.layer));
