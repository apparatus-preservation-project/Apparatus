...
public class ObjectManager {
	...
	public void add_to_layer(int layer, GrabableObject o) {
		add_to_layer(layer == 0 ? this.layer0 : layer == 1 ? this.layer1 : this.layer2, o);
	}
	...
	public void add(GrabableObject o) {
		Layer layer = o.layer == 0 ? this.layer0 : o.layer == 1 ? this.layer1 : this.layer2;
	...
	public void remove(GrabableObject o) {
		if (o instanceof RopeEnd) {
			...
			remove_from_layer(o.layer == 0 ? this.layer0 : o.layer == 1 ? this.layer1 : this.layer2, o);
		}
	}
	...
	public void relayer(GrabableObject o, int layer) {
		int i = o.layer;
		Layer c_layer = o.layer == 0 ? this.layer0 : o.layer == 1 ? this.layer1 : this.layer2;
		Layer n_layer = layer == 0 ? this.layer0 : layer == 1 ? this.layer1 : this.layer2;
		if (c_layer != n_layer) {
			if (!(o instanceof RopeEnd)) {
