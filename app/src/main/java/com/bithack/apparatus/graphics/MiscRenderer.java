...
public class MiscRenderer {
	...
	private static void create_hqcylindermesh() {
		...
		int c = 0;
		for (int x = 0; x <= 24; x++) {
			float a = 0.2617994f * ((float) x);
			v[c] = (float) Math.cos((double) a);
			v[c + 1] = (float) Math.sin((double) a);
			v[c + 2] = 0.5f;
			v[c + 3] = (float) Math.cos((double) (a - 0.2617994f));
			v[c + 4] = (float) Math.sin((double) (a - 0.2617994f));
			v[c + 5] = 0.0f;
			v[c + 6] = ((float) x) / 24.0f;
			v[c + 7] = 1.0f;
			normalize(v, c + 3);
			int c2 = c + 8;
			v[c2] = (float) Math.cos((double) a);
			v[c2 + 1] = (float) Math.sin((double) a);
			v[c2 + 2] = -0.5f;
			v[c2 + 3] = v[(c2 + 3) - 8];
			v[c2 + 4] = v[(c2 + 4) - 8];
			v[c2 + 5] = 0.0f;
			v[c2 + 6] = ((float) x) / 24.0f;
			v[c2 + 7] = 0.0f;
			normalize(v, c2 + 3);
			int c3 = (c2 + 8) - 16;
			v[c3 + 400] = ((float) Math.cos((double) a)) * 0.9f;
			v[c3 + 400 + 1] = ((float) Math.sin((double) a)) * 0.9f;
			v[c3 + 400 + 2] = 0.6f;
			v[c3 + 400 + 3] = 0.0f;
			v[c3 + 400 + 4] = 0.0f;
			v[c3 + 400 + 5] = 1.0f;
			v[c3 + 400 + 6] = ((float) x) / 24.0f;
			v[c3 + 400 + 7] = 1.0f;
			int c4 = c3 + 8;
			v[c4 + 400] = (float) Math.cos((double) a);
			v[c4 + 400 + 1] = (float) Math.sin((double) a);
			v[c4 + 400 + 2] = 0.5f;
			v[c4 + 400 + 3] = (float) Math.cos((double) a);
			v[c4 + 400 + 4] = (float) Math.sin((double) a);
			v[c4 + 400 + 5] = 0.0f;
			v[c4 + 400 + 6] = ((float) x) / 24.0f;
			v[c4 + 400 + 7] = 0.0f;
			normalize(v, c4 + 400 + 3);
			c = c4 + 8;
			v[((x + 1) * 8) + 800 + 0] = ((float) Math.cos((double) a)) * 0.9f;
			v[((x + 1) * 8) + 800 + 1] = ((float) Math.sin((double) a)) * 0.9f;
			v[((x + 1) * 8) + 800 + 2] = 0.6f;
			v[((x + 1) * 8) + 800 + 3] = (float) Math.cos((double) a);
			v[((x + 1) * 8) + 800 + 4] = (float) Math.sin((double) a);
			v[((x + 1) * 8) + 800 + 5] = 1.0f;
			normalize(v, ((x + 1) * 8) + 800 + 3);
			v[((x + 1) * 8) + 800 + 6] = (((float) Math.cos((double) a)) * 0.5f) + 0.5f;
			v[((x + 1) * 8) + 800 + 7] = (((float) Math.sin((double) a)) * 0.5f) + 0.5f;
		}
		v[800] = 0.0f;
		v[801] = 0.0f;
		v[802] = 0.6f;
		...
		v[806] = 0.5f;
		v[807] = 0.5f;
		hqcylindermesh = new Mesh(true, 126, 0, new VertexAttribute(1, 3, "a_position"), new VertexAttribute(8, 3, "a_normal"), new VertexAttribute(16, 2, "a_texcoords"));
	...
	private static void create_cylindermesh() {
		...
		for (int x = 0; x <= 24; x++) {
			...
			normalize(v, c2 + 3);
			c = c2 + 8;
			v[((x + 1) * 8) + 400 + 0] = (float) Math.cos((double) a);
			v[((x + 1) * 8) + 400 + 1] = (float) Math.sin((double) a);
			v[((x + 1) * 8) + 400 + 2] = 0.5f;
			v[((x + 1) * 8) + 400 + 3] = (float) Math.cos((double) a);
			v[((x + 1) * 8) + 400 + 4] = (float) Math.sin((double) a);
			v[((x + 1) * 8) + 400 + 5] = 1.0f;
			normalize(v, ((x + 1) * 8) + 400 + 3);
			v[((x + 1) * 8) + 400 + 6] = (((float) Math.cos((double) a)) * 0.5f) + 0.5f;
			v[((x + 1) * 8) + 400 + 7] = (((float) Math.sin((double) a)) * 0.5f) + 0.5f;
		}
		v[400] = 0.0f;
		v[401] = 0.0f;
		v[402] = 0.5f;
		...
		v[406] = 0.5f;
		v[407] = 0.5f;
		cylindermesh = new Mesh(true, 76, 0, new VertexAttribute(1, 3, "a_position"), new VertexAttribute(8, 3, "a_normal"), new VertexAttribute(16, 2, "a_texcoords"));
		cylindermesh.setVertices(v);
	}

	private static void create_smallcylindermesh() {
		float[] v = new float[152];
		int c = 0;
		for (int x = 0; x <= 5; x++) {
			float a = 1.2566371f * ((float) x);
			v[c] = (float) Math.cos((double) a);
			v[c + 1] = (float) Math.sin((double) a);
			v[c + 2] = 0.5f;
			v[c + 3] = (float) Math.cos((double) a);
			v[c + 4] = (float) Math.sin((double) a);
			v[c + 5] = 0.3f;
			v[c + 6] = ((float) x) / 5.0f;
			v[c + 7] = 1.0f;
			normalize(v, c + 3);
			...
			normalize(v, c2 + 3);
			c = c2 + 8;
			v[((x + 1) * 8) + 96 + 0] = (float) Math.cos((double) a);
			v[((x + 1) * 8) + 96 + 1] = (float) Math.sin((double) a);
			v[((x + 1) * 8) + 96 + 2] = 0.5f;
			v[((x + 1) * 8) + 96 + 3] = (float) Math.cos((double) a);
			v[((x + 1) * 8) + 96 + 4] = (float) Math.sin((double) a);
			v[((x + 1) * 8) + 96 + 5] = 2.0f;
			normalize(v, ((x + 1) * 8) + 96 + 3);
			v[((x + 1) * 8) + 96 + 6] = (((float) Math.cos((double) a)) * 0.5f) + 0.5f;
			v[((x + 1) * 8) + 96 + 7] = (((float) Math.sin((double) a)) * 0.5f) + 0.5f;
		}
		v[96] = 0.0f;
		v[97] = 0.0f;
		v[98] = 0.5f;
		...
		v[102] = 0.5f;
		v[103] = 0.5f;
		smallcylindermesh = new Mesh(true, 19, 0, new VertexAttribute(1, 3, "a_position"), new VertexAttribute(8, 3, "a_normal"), new VertexAttribute(16, 2, "a_texcoords"));
		smallcylindermesh.setVertices(v);
	}

	private static void normalize(float[] v, int offs) {
		float x = (float) Math.sqrt((double) ((v[offs] * v[offs]) + (v[offs + 1] * v[offs + 1]) + (v[offs + 2] * v[offs + 2])));
		if (x > 1.0E-4f) {
			v[offs] = v[offs] / x;
			int i = offs + 1;
			v[i] = v[i] / x;
	...
	private static void create_spheremesh() {
		...
		int c = 0;
		spheremesh = new Mesh(true, 1296, 0, new VertexAttribute(1, 3, "a_position"), new VertexAttribute(8, 3, "a_normal"), new VertexAttribute(16, 2, "a_texcoords"));
		for (int b = 0; b <= 180; b += 20) {
			for (int a = 0; a <= 340; a += 20) {
				v[c] = ((float) (Math.sin(((double) (((float) a) / 180.0f)) * 3.141592653589793d) * Math.sin(((double) (((float) b) / 180.0f)) * 3.141592653589793d))) * 0.5f;
				v[c + 1] = (-((float) (Math.cos(((double) (((float) a) / 180.0f)) * 3.141592653589793d) * Math.sin(((double) (((float) b) / 180.0f)) * 3.141592653589793d)))) * 0.5f;
				v[c + 2] = ((float) Math.cos(((double) (((float) b) / 180.0f)) * 3.141592653589793d)) * 0.5f;
				v[c + 3] = v[c] * 2.0f;
				v[c + 4] = v[c + 1] * 2.0f;
				v[c + 5] = v[c + 2] * 2.0f;
				v[c + 6] = ((float) (b * 2)) / 360.0f;
				v[c + 7] = ((float) a) / 360.0f;
				int c2 = c + 8;
				v[c2] = ((float) (Math.sin(((double) (((float) a) / 180.0f)) * 3.141592653589793d) * Math.sin(((double) (((float) (b + 20)) / 180.0f)) * 3.141592653589793d))) * 0.5f;
				v[c2 + 1] = (-((float) (Math.cos(((double) (((float) a) / 180.0f)) * 3.141592653589793d) * Math.sin(((double) (((float) (b + 20)) / 180.0f)) * 3.141592653589793d)))) * 0.5f;
				v[c2 + 2] = ((float) Math.cos(((double) (((float) (b + 20)) / 180.0f)) * 3.141592653589793d)) * 0.5f;
				v[c2 + 3] = v[c2] * 2.0f;
				v[c2 + 4] = v[c2 + 1] * 2.0f;
				v[c2 + 5] = v[c2 + 2] * 2.0f;
				v[c2 + 6] = ((float) ((b + 20) * 2)) / 360.0f;
				v[c2 + 7] = ((float) a) / 360.0f;
				int c3 = c2 + 8;
				v[c3] = ((float) (Math.sin(((double) (((float) (a + 20)) / 180.0f)) * 3.141592653589793d) * Math.sin(((double) (((float) b) / 180.0f)) * 3.141592653589793d))) * 0.5f;
				v[c3 + 1] = (-((float) (Math.cos(((double) (((float) (a + 20)) / 180.0f)) * 3.141592653589793d) * Math.sin(((double) (((float) b) / 180.0f)) * 3.141592653589793d)))) * 0.5f;
				v[c3 + 2] = ((float) Math.cos(((double) (((float) b) / 180.0f)) * 3.141592653589793d)) * 0.5f;
				v[c3 + 3] = v[c3] * 2.0f;
				v[c3 + 4] = v[c3 + 1] * 2.0f;
				v[c3 + 5] = v[c3 + 2] * 2.0f;
				v[c3 + 6] = ((float) (b * 2)) / 360.0f;
				v[c3 + 7] = ((float) (a + 20)) / 360.0f;
				int c4 = c3 + 8;
				v[c4] = ((float) (Math.sin(((double) (((float) (a + 20)) / 180.0f)) * 3.141592653589793d) * Math.sin(((double) (((float) (b + 20)) / 180.0f)) * 3.141592653589793d))) * 0.5f;
				v[c4 + 1] = (-((float) (Math.cos(((double) (((float) (a + 20)) / 180.0f)) * 3.141592653589793d) * Math.sin(((double) (((float) (b + 20)) / 180.0f)) * 3.141592653589793d)))) * 0.5f;
				v[c4 + 2] = ((float) Math.cos(((double) (((float) (b + 20)) / 180.0f)) * 3.141592653589793d)) * 0.5f;
				v[c4 + 3] = v[c4] * 2.0f;
				v[c4 + 4] = v[c4 + 1] * 2.0f;
				v[c4 + 5] = v[c4 + 2] * 2.0f;
				v[c4 + 6] = ((float) ((b + 20) * 2)) / 360.0f;
				v[c4 + 7] = ((float) (a + 20)) / 360.0f;
				c = c4 + 8;
			}
		}
	...
	public static void initialize() {
		squaremesh = new Mesh(true, 4, 0, new VertexAttribute(1, 2, "a_position"), new VertexAttribute(16, 2, "a_texcoord"));
		boxmesh = new Mesh(true, 4, 0, new VertexAttribute(1, 2, "a_position"), new VertexAttribute(16, 2, "a_texcoord"));
		sboxmesh = new Mesh(false, 4, 0, new VertexAttribute(1, 2, "a_position"), new VertexAttribute(16, 2, "a_texcoord"));
		axesmesh = new Mesh(true, 4, 0, new VertexAttribute(1, 2, "a_position"), new VertexAttribute(4, 4, "a_color"));
		circlemesh = new Mesh(true, 24, 0, new VertexAttribute(1, 2, "a_position"));
		create_spheremesh();
		create_cylindermesh();
		...
		for (int x = 0; x < 24; x++) {
			v2[(x * 2) + 0] = (float) Math.cos((double) (((float) x) * 0.2617994f));
			v2[(x * 2) + 1] = (float) Math.sin((double) (((float) x) * 0.2617994f));
		}
		circlemesh.setVertices(v2);
		cubemesh = new Mesh(true, 30, 0, new VertexAttribute(1, 3, "a_position"), new VertexAttribute(8, 3, "a_normal"), new VertexAttribute(16, 2, "a_texcoords"));
		hqmetalmesh = new Mesh(true, 162, 0, new VertexAttribute(1, 3, "a_position"), new VertexAttribute(8, 3, "a_normal"), new VertexAttribute(16, 2, "a_texcoords"));
		hqplankmesh = new Mesh(true, 162, 0, new VertexAttribute(1, 3, "a_position"), new VertexAttribute(8, 3, "a_normal"), new VertexAttribute(16, 2, "a_texcoords"));
		hqcubemesh = new Mesh(true, 54, 0, new VertexAttribute(1, 3, "a_position"), new VertexAttribute(8, 3, "a_normal"), new VertexAttribute(16, 2, "a_texcoords"));
		cubesides = new Mesh(true, 24, 0, new VertexAttribute(1, 3, "a_position"), new VertexAttribute(8, 3, "a_normal"), new VertexAttribute(16, 2, "a_texcoords"));
